...
function decodeUpTo7DiffInPairs(pixelPairs, diffBitsMap) {
    const readOrder = [];
...
function decryptFromLocMapInPairs(pixelPairs, locMap7) {
    const decryptedBits = [];
...
function pixelPairsToPixelArray(pairs, pixelDepth) {
