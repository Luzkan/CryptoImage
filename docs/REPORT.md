...
##### [Paper](./papers/), [Wikipedia - _Differential Form_](https://en.wikipedia.org/wiki/Differential_form)
...
##### [Paper](./papers/), [Wikipedia - _Histogram_](https://en.wikipedia.org/wiki/Histogram)
